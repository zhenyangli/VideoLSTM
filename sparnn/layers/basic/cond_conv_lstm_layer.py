...
'''
class CondConvLSTMLayer(Layer):
    def __init__(self, layer_param):
        super(CondConvLSTMLayer, self).__init__(layer_param)
        ...
        self.Wd_att = quick_init_xavier(self.rng, (self.feature_out, self.feature_out), self._s("Wd_att"))
        # attention: input -> hidden
        self.Wc_att = quick_init_xavier(self.rng, (self.feature_in, self.feature_out), self._s("Wc_att"))
        # attention: hidden bias
        self.b_att = quick_zero((self.feature_out, ), self._s("b_att"))
        # attention:
        self.U_att = quick_init_xavier(self.rng, (self.feature_out, 1), self._s("U_att"))
    ...
    def set_name(self):
        self.name = "CondConvLSTMLayer-" + str(self.id)
