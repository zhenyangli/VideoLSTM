...
save_path = "./ucf101-experiment/ucf101-rgb-convALSTM/rms-lr-0.001-drop-0.7/"
log_path = save_path + "evaluate_ucf101_rgb_convALSTM.log"
...
param = {"id": 2, "rng": rng, "theano_rng": theano_rng,
         ...
         "n_steps": seq_length}
middle_layers.append(CondConvLSTMSoftLayer(param))
...
param = {'interface_layer': interface_layer, 'middle_layers': middle_layers, 'cost_layer': cost_layer,
         ...
         'name': "UCF101-VideoModel-RGB-convALSTM-RMS",
