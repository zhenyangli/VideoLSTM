...
save_path = "./ucf101-experiment/ucf101-rgb-convLSTM/rms-lr-0.001-drop-0.7/"
log_path = save_path + "evaluate_ucf101_rgb_convLSTM.log"
...
param = {'interface_layer': interface_layer, 'middle_layers': middle_layers, 'cost_layer': cost_layer,
         ...
         'name': "UCF101-VideoModel-RGB-convLSTM-RMS",
