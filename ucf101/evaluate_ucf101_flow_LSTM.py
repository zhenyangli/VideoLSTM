...
save_path = "./ucf101-experiment/ucf101-flow-LSTM/rms-lr-0.001-drop-0.5/"
log_path = save_path + "evaluate_ucf101_flow_LSTM.log"
...
iterator_param = {'dataset': 'ucf101',
                  'data_file': '/ssd/zhenyang/data/UCF101/features/flow_vgg16_fc7',
...
############################# interface layer
param = {"id": "ucf101-flow-vgg16-fc7", "use_mask": True,
